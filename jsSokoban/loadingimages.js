...
const row3column4 = {//BOW "
    rowCoordinate: 3, columnCoordinate: 4, floorOrWall: 0, isPlayer: 0, isBox: 1, isButton: 0,type: 0,
}
...
const row4column4 = {//B W "
    rowCoordinate: 4, columnCoordinate: 4, floorOrWall: 0, isPlayer: 0, isBox: 1, isButton: 0,type: 0,
}
const row4column5 = {// W "
...
const row6column1 = {//B XBBOW"
    rowCoordinate: 6, columnCoordinate: 1, floorOrWall: 0, isPlayer: 0, isBox: 1, isButton: 0,type: 0,
}
...
const row6column3 = {//XBBOW"
    rowCoordinate: 6, columnCoordinate: 3, floorOrWall: 0, isPlayer: 0, isBox: 1, isButton: 1,type: 0,
}
const row6column4 = {//BBOW"
    rowCoordinate: 6, columnCoordinate: 4, floorOrWall: 0, isPlayer: 0, isBox: 1, isButton: 0,type: 0,
}
const row6column5 = {//BOW"
    rowCoordinate: 6, columnCoordinate: 5, floorOrWall: 0, isPlayer: 0, isBox: 1, isButton: 0,type: 0,
}
  ...
  function transcribeMap(){
    ...
    for(let rowIndex = 0; rowIndex < mapConversion.length; rowIndex ++) {
        ...
        for(let columnIndex = 0; columnIndex < mapConversion[rowIndex].length; columnIndex++){
            ...
            if(mapConversion[rowIndex][columnIndex].isButton === 1 && mapConversion[rowIndex][columnIndex].isBox === 1){
                numberOfLights++
            }
 
            cellDiv.className = buildingClassName;
            cellDiv.innerHTML = cellNumber;
            ...
            if(mapConversion[rowIndex][columnIndex].isBox === 1)  {
                drawPiece(rowIndex,columnIndex, boxToken)
            }
...
//rowCoordinate: 7, columnCoordinate: 2, floorOrWall: 0, isPlayer: 0, isBox: 0, isButton: 0,
    ...
    lightSwitch(numberOfLights);
}
const playerToken = '<img src = "images/chipdown.png" alt ="player token" height = "25px" width = "25px">'
const boxToken = '<img src = "images/box.png" alt = "box token" height = "25px" width = "25px">'
document.onload = transcribeMap();


function drawPiece(row, column,pieceType){
    let cellDivId = row +"." + column;
    document.getElementById(cellDivId).innerHTML = pieceType
}
